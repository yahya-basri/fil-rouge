<div>
    ...
    <div class="mt-5 grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        @can('module.show') {{-- Assuming 'module.show' is the correct permission for viewing users/modules --}}
        ...
        <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            @forelse ($badges as $badge)
                <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{ $badge->description }}</p>
                </div>
            @empty
                <p class="text-gray-600 dark:text-gray-400">No badges earned yet. Complete modules to earn them!</p>
            @endforelse
        </div>
    </div>
</div>